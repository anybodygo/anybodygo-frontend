...
export default function Card({ guid, id, chatName, from, to, dateFrom, dateTo, message, context, hasReward, messageLink, setPopupId = f => f, fullText = false }) {
