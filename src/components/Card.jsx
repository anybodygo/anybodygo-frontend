...
export default function Card({
  ...
  return (
    <div
      className={`card-main ${disabled ? " disabled" : ""}`}
      onClick={openInPopup}
    >
      <div className="card-title">
        ...
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M8.35165 0.351785C8.57668 0.126538 8.88185 1.55408e-06 9.20005 1.54017e-06C9.51825
      ...
      <div className={`card-text ${fullText ? "popup-card-text" : ""}`}>
        {message}
        {longText && fullText === false ? (
          <div className="card-text-blur"></div>
        ) : (
          ""
        )}
      </div>
